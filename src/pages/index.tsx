...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Raport generator`}</title>

        <meta
          name="description"
          content="Raport Generator: Unleashing the power of data to analyze business niches in specific Polish regions. Choose your location and niche, let us do the rest."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1542744173-05336fcc7ad4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGFuYWx5c2lzfGVufDB8fHx8MTY5NjkzMDk2MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Raport Generator: Unleashing the power of data to analyze business niches in specific Polish regions. Choose your location and niche, let us do the rest.`}
            </Text>
            <Box
