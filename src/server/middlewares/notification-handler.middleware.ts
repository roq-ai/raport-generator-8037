...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': {
    roles: ['business-owner', 'business-analyst'],
    key: 'order_id',
    tenantPath: [],
    userPath: [],
  },
  'low_inventory.update': {
    roles: ['business-owner', 'business-analyst'],
    key: 'product_id',
    tenantPath: [],
    userPath: [],
  },
  'payment_received.create': { roles: ['business-owner'], key: 'payment_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['business-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['business-owner', 'business-analyst'];
