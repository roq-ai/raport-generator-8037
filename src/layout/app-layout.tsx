...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'business-analyst'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Niches', path: '/niches', entity: 'niche', service: AccessServiceEnum.PROJECT, icon: FiTarget },
    {
      name: 'Population Growths',
      path: '/population-growths',
      entity: 'population_growth',
      service: AccessServiceEnum.PROJECT,
      icon: FiBarChart2,
    },
    { name: 'Regions', path: '/regions', entity: 'region', service: AccessServiceEnum.PROJECT, icon: FiMap },
    { name: 'Reports', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiFileText },
